...
namespace BatteryChangeCharger.Databases
{
    abstract public class Database_Setting_Base
    {
        ...
        public bool getData_Bool_To_Bool(bool booldata)
        {
            if(booldata)
                return true;
            else 
        ...
        public void SetData_Bool_To_Bool(bool booldata , bool setting)
        {
            booldata = setting;
        }

        public void SetDoor_Open(int num)
        {
            switch (num)
            {
                case 1:
                    IOBoard_cb_Send.SLOT1_Door_Open = true;
                    break;
                case 2:
                    IOBoard_cb_Send.SLOT2_Door_Open = true;
                    break;
                case 3:
                    IOBoard_cb_Send.SLOT3_Door_Open = true;
                    break;
                case 4:
                    IOBoard_cb_Send.SLOT4_Door_Open = true;
                    break;
                case 5:
                    IOBoard_cb_Send.SLOT5_Door_Open = true;
                    break;
                case 6:
                    IOBoard_cb_Send.SLOT6_Door_Open = true;
                    break;
                case 7:
                    IOBoard_cb_Send.SLOT7_Door_Open = true;
                    break;
                case 8:
                    IOBoard_cb_Send.SLOT8_Door_Open = true;
                    break;
            }
            
        }

        public void SetDoor_Close(int num)
        {
            switch (num)
            {
                case 1:
                    IOBoard_cb_Send.SLOT1_Door_Open = false;
                    break;
                case 2:
                    IOBoard_cb_Send.SLOT2_Door_Open = false;
                    break;
                case 3:
                    IOBoard_cb_Send.SLOT3_Door_Open = false;
                    break;
                case 4:
                    IOBoard_cb_Send.SLOT4_Door_Open = false;
                    break;
                case 5:
                    IOBoard_cb_Send.SLOT5_Door_Open = false;
                    break;
                case 6:
                    IOBoard_cb_Send.SLOT6_Door_Open = false;
                    break;
                case 7:
                    IOBoard_cb_Send.SLOT7_Door_Open = false;
                    break;
                case 8:
                    IOBoard_cb_Send.SLOT8_Door_Open = false;
                    break;
            }

        }

        public void setData_Int_To_Int(int intdata, int setting)
        {
            intdata = setting;
        }

        public void setData_String_To_String(string stringdata, string setting)
        {
            stringdata = setting;
        }
        ...
        {
            string value = getSettingData_Database(indexArray);
            int value_Int = Manager_Conversion.getInt(value);
            return value_Int;
