...
{
    public partial class P788_BCC_UC_ChargingMain_Include_Wait_Insert_Battery : UserControl
    {
        public P788_BCC_UC_ChargingMain_Include_Wait_Insert_Battery()
        {
            InitializeComponent();
        ...
        public void setContent_Insert_Battery_1st()
        {
            ...
            label_content.Text = "화면에 표시된 투입구로\n첫번째 배터리를 반납하여 주십시오.";
        }
        ...
        public void setContent_Wait_Open_Door()
        {
            ...
            circularProgressBar1.Visible = false;
            label1.Visible = false;
            label_content.Text = "도어가 열리는 중입니다.\n완전히 열릴때까지 잠시만 기다려 주세요.";
        }
