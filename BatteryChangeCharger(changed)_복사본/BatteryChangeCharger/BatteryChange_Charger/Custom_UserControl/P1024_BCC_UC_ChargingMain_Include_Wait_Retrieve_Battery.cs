...
{
    public partial class P1024_BCC_UC_ChargingMain_Include_Wait_Retrieve_Battery : UserControl
    {
        public P1024_BCC_UC_ChargingMain_Include_Wait_Retrieve_Battery()
        {
            InitializeComponent();
        ...
        public void setContent_Retrieve_Battery_1st(int socketNumber)
        {
            ...
            label_content.Text = "화면에 표시된 첫번째 배터리팩을 인출하여 주십시오.";
        }
        ...
        public void setContent_Retrieve_Battery_1st_Complete()
        {
            ...
            label_content.Text = "첫번째 배터리가 인출되었습니다.";
        }
        ...
        public void setContent_Retrieve_Battery_2nd(int socketNumber)
        {
            ...
            label1.Visible = true;
            circularProgressBar1.Value = MyApplication.getInstance().SerialPort_NFCBoard.getManager_Send().mPackets[socketNumber - 1].mPacket_c1_Receive.SOC;
            label_content.Text = "화면에 표시된 두번째 배터리팩을 인출하여 주십시오.";
        }
        ...
        public void setContent_Retrieve_Battery(int socketNumber)
        {
            ...
            label1.Visible = true;
            circularProgressBar1.Value = MyApplication.getInstance().SerialPort_NFCBoard.getManager_Send().mPackets[socketNumber - 1].mPacket_c1_Receive.SOC;
            label_content.Text = "화면에 표시된 배터리팩을 인출하여 주십시오.";
        }
        ...
        public void setContent_Retrieve_Battery_2nd_Complete()
        {
            ...
            circularProgressBar1.Visible = false;
            label1.Visible = false;
            label_content.Text = "두번째 배터리가 인출되었습니다.";
        }

        public void setContent_Retrieve_Battery_Complete()
        {
            pictureBox1.Visible = false;
            circularProgressBar1.Visible = false;
            label1.Visible = false;
            label_content.Text = "배터리가 인출되었습니다.";
        }
    }
}
