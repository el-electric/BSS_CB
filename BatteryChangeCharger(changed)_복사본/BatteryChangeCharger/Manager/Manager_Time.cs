...
namespace BatteryChangeCharger.Manager
{
    public class Manager_Time
    {
        ...
        public static int GetCurrentDate_Int() => Manager_Conversion.getInt(GetCurrentDate());
        public static int GetCurrentTime_Int() => Manager_Conversion.getInt(GetCurrentTime());
        ...
        public static byte[] getBcdCode3Byte_hhmmss_From_Second(double second)
        {
            ...
            return Manager_Bcd.stringToBCD(data);
        }
