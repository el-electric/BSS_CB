...
namespace Acs.Readers.Pcsc
{
    public class PcscProvider
    {
        ...
        //NFC Library
        public const int ACS_NFC_ERR_IO = 1;
        public const int ACS_NFC_ERR_INVALID = 2;
        public const int ACS_NFC_ERR_DEV_NOT_SUPP = 3;
        public const int ACS_NFC_ERR_NOT_SUCH_DEV = 4;
        public const int ACS_NFC_ERR_NOT_DATA = 5;
        public const int ACS_NFC_ERR_TIMEOUT = 6;
        public const int ACS_NFC_ERR_FAIL = 7;
        public const int ACS_NFC_ERR_RF_TRANS = 8;
        public const int ACS_NFC_ERR_SOFT = 9;
